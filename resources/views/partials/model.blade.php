...
<div class="wrap-modal1 js-modal1 p-t-60 p-b-20" id="{{$item->id}}">
                        ...
                        <div class="p-t-33">
                            ...
                            <div class="flex-w flex-r-m p-b-10">
                                <div class="size-204 flex-w flex-m respon6-next">
                                    ...
                                    <button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail" onclick="addCart(21)">
                                        Add to cart
                                    </button>
                                </div>
                            </div>
