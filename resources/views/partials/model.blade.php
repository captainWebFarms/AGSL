                            ...
                            <div class="flex-w flex-r-m p-b-10">
                                <div class="size-204 flex-w flex-m respon6-next">
                                    <div class="wrap-num-product flex-w m-r-20 m-tb-10">
                                        ...
                                        <input class="mtext-104 cl3 txt-center num-product" type="number" id="qty{{$item->id}}" name="qty" value="1">
                                    ...
                                    <button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail" onclick="addCart('{{$item->id}}','{{$item->name}}','{{$item->price}}','{{$item->img}}',document.getElementById('qty{{$item->id}}').value)">
                                        Add to cart
                                    </button>
